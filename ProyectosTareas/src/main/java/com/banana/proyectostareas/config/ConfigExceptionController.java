...
public class ConfigExceptionController {
    ...
    public ResponseEntity<Object> handlProyectoNotfoundException(ProyectoNotFoundException exception) {
        System.out.println(">>> EXCEPCIÓN: ProyectoNotFoundException");
        //return new ResponseEntity<>("Project not found", HttpStatus.NOT_FOUND);
        return new ResponseEntity<>(exception.getMessage(), HttpStatus.NOT_FOUND); // Muestra el mensaje que le envía la excepción de ProyectoServiceController.
    }

    @ExceptionHandler(value = TareaNotFoundException.class)
    public ResponseEntity<Object> handleTareaNotfoundException(TareaNotFoundException exception) {
        System.out.println(">>> EXCEPCIÓN: TareaNotFoundException");
        //return new ResponseEntity<>("Task not found", HttpStatus.NOT_FOUND);
        return new ResponseEntity<>(exception.getMessage(), HttpStatus.NOT_FOUND); // Muestra el mensaje que le envía la excepción de TareaServiceController.
    }
    ...
    public ResponseEntity<Object> handleJsonMappingException(JsonMappingException exception) {
        ...
        return new ResponseEntity<>("Error JSON (envío recurso BODY mal formado) --> " + exception.getMessage(), HttpStatus.UNPROCESSABLE_ENTITY); // Muestra el mensaje que le envía la excepción de ProyectoServiceController/TareaServiceController.
    }
    ...
    // Excepción 'MethodArgumentNotValidException' --> El argumento del método no es válido: aparece cuando envío un recurso mal formado (BODY)
